...
author: "YourName, YourInstitution"
date: "`r format(Sys.Date(), '%A, %B %d, %Y')`"
output:
    html_document:
        code_folding: hide # hide code but shows a button that makes it appear
        css: custom.css # code in the folder, for the coats to be smaller
        toc: TRUE
        toc_float: true # table of contents as a side bar
        toc_depth: 2 # code highlight
        theme: readable
        highlight: kate #?
        number_sections: yes
bibliography:
- oajournals.bib
- packages.bib
#csl: apa # citation style of preference (numbered, for example). you will need to download a citation style file from a repository and add it to your rmd project directory.
---
...
||>
This code chunck add the LaTeX equations in the file equations-child.Rmd :)
...
ORCID: [0000-0001-8424-9396](orcid.org/0000-0001-8424-9396)
...
This is auto-populated from your ORCID profile using the @R-rorcid package.
